...
import javax.swing.Timer;
 ...
 /*
 * Extensión de JPanel que muestra un reloj digital
...
public class Reloj extends JPanel implements ActionListener {
    ...
    public Reloj(boolean booUTC){
        this(Calendar.getInstance().get(Calendar.HOUR_OF_DAY)+7, Calendar.getInstance().get(Calendar.MINUTE),Calendar.getInstance().get(Calendar.SECOND), booUTC);
    }
    /**
